...
@section('content')
  ...
  <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" action="{{ route('posts.update', $post->id) }}" method="post">
    @csrf
    @method('PUT')
    ...
    <div class="mb-4">
      ...
      <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="title" type="text" placeholder="Título" name="title" value="{{ $post->title }}">
    </div>
    <div class="mb-6">
